...
if( !is_single( ) ) { 
	?>
	<article id="post-<?php the_ID(); ?>" <?php post_class(array('article-block audio_block wow fadeInUp')); ?>>
		<?php if(viaggio_media_content()) :?>
		<div class="feature_block">
			<?php echo viaggio_media_content(array('audio','iframe'))?>
		</div>
	<?php endif;?>
		...
		<div class="row">
			<div class="<?php if(cs_get_option('full_wide') == 'full') { echo 'col-md-12'; }else{ echo 'col-md-8 col-sm-8';}?>">
				<div class="the_content">
					<?php echo viaggio_media_content();?>
					...
					<?php do_action('viaggio-content_footer');?>
