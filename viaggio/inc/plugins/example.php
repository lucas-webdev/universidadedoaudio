...
add_action( 'tgmpa_register', 'viaggio_register_required_plugins' );
 ...
 */
function viaggio_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			...
			'slug'               => 'codestarframework', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/inc/plugins/framework.zip', // The plugin source.
